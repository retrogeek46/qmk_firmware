...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
        KC_ESC,  KC_1,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS,
        ...
        KC_LCTL, KC_LALT, KC_SPC,  MO(1),   KC_BSPC,  KC_LGUI, KC_LEFT, KC_DOWN, KC_RGHT
    ),

    [1] = LAYOUT(
        KC_DEL,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSLS,
        _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,
        KC_RSFT, RGB_TOG, RGB_MOD, _______, _______, _______, _______, _______, KC_MUTE, _______, _______, _______, KC_VOLU, _______,
        _______, _______, _______, _______, _______, _______, _______, KC_VOLD, _______
    ),

    [2] = LAYOUT(
        KC_TILD, _______, _______, KC_END,  _______, _______, _______, _______, KC_INS,  _______, KC_PSCR, _______, _______, QK_BOOT,
